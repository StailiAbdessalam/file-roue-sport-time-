<template>
    <section class="py-20 px-4 lg:px-16 overflow-hidden relative z-10" data-aos="fade-up" id="contact">
        <div class="container">
            <div class="mb-5 flex items-center max-w-md">
                <h2 class="text-slate-900 text-yellow-400 dark:text-gray-200 text-3xl font-bold"> Contact Me</h2>
            </div>
            <div
                ...
                <div class="w-full lg:w-1/2 xl:w-5/12 px-4" data-aos="fade-up" data-aos-delay="500"
                    ...
                    <div class="bg-gray-100 dark:bg-slate-800 relative rounded-lg p-8 sm:p-12 shadow-lg">
                        <form @submit.prevent>
                            ...
                            <div class="mb-6">
                                <input inputMode="numeric" placeholder="Your Phone" class="
                                    w-full
                                    rounded
                                    p-3
                                    text-gray-800
