    ...
    <div style="
      ...
      ">
        <div id="my-scroll" style="margin: 6px 14px 0 14px">
            <ul class="nav-list" style="overflow: visible">
                <li v-if="isSearch" @click="isOpened = true">
                    ...
                    <input type="text" placeholder="Search..." @input="$emit('search-input-emit', $event.target.value)" />
        ...
        <div class="profile">
            ...
            <i v-if="isExitButton" class="bx bx-log-out hover:cursor-pointer" id="log_out" @click="logout()" />
        </div>
    </div>
</div>
</template>
