    ...
    <div class="main-content">
          ...
          <div class="row">
            <div class="col-lg-7 col-md-10">
              <h1 class="display-2 text-white">
                Bonjour Dans {{ local.business_name }}
              </h1>
      ...
      <div class="container-fluid mt--7">
        <div class="row">
              ...
              <div class="card-body pt-0 pt-md-4">
                ...
                <div class="text-center">
                  ...
                  <div class="h5 font-weight-300">
                    <i class="ni location_pin mr-2"></i>{{ local.Ville }}, Maroc
                  </div>
                  <div class="h5 mt-4">
                  ...
                  <div>
                    <i class="ni education_hat mr-2"></i>{{ local.Phone }}
                  </div>
                  <hr class="my-4" />
                  <p>{{ local.About }}</p>
                </div>
          ...
          <div class="col-xl-8 order-xl-1 overflow-scroll max-h-screen">
            <div class="card bg-secondary shadow">
              <div class="card-header bg-white border-0">
                <div class="row align-items-center">
                  <div class="col-8">
                    <h3 class="mb-0">My Stadieum</h3>
                  </div>
...
<div class="flex flex-col justify-center gap-10 mt-4 mb-4">
	<div v-for="stad in stade" :key="stad"
		class="relative flex flex-col md:flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-3 max-w-xs md:max-w-3xl mx-auto border border-white bg-white">
		<div class="w-full md:w-1/3 bg-white grid place-items-center">
			<img :src="`https://firebasestorage.googleapis.com/v0/b/sport-time-763e8.appspot.com/o/Stade%2F${stad.images}.png?alt=media&token=e6d58393-e912-48f7-801d-06e9fa624757`" alt="tailwind logo" class="rounded-xl h-48 w-96" />
    </div>
			<div class="w-full md:w-2/3 bg-white flex flex-col space-y-2 p-3">
				<div class="flex justify-between">
					<p class="text-gray-500 font-medium hidden md:block">{{stad.Type}}</p>
					<div class="flex ">
              ...
              <button class="btn btn-info">RESERVER</button>
				...
				<h3 class="font-black text-gray-800 md:text-3xl text-xl">{{stad.Title}}</h3>
				<p class="md:text-lg text-gray-500 text-base">{{stad.Description}}</p>
...
export default {
  ...
  methods: {
    getlocal() {
      axios
        .post("http://localhost/FILEROUGE/Organisateur/selectOneLocal", {
    ...
    getAllStade() {
      axios
        .post("http://localhost/FILEROUGE/Stade/getAllStadebyId", {
          id: this.$route.params.id,
        })
        .then((res) => {
          this.stade = res.data;
